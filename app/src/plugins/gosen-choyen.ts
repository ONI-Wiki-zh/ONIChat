...
export const apply = async (ctx: Context, config: ConfigObject) => {
...
const generateImage = (upper: string, lower: string, options: ImageGeneratorOptions) => {
